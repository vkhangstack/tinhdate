function colorResult(color) {
  if (color > 65) {
    ...
    document.getElementById("textFunny").innerHTML = "Sản phẩm dường như không đạt quy định chất lượng!"
    document.getElementById("textFunny").style.color = "red"
  } else {
    document.getElementById("dayCount").style.color = "red"
    document.getElementById("textFunny").innerHTML = "Lỗi rồi kìa. Xem lại NSX, HSD đã nhập chưa nè"
    document.getElementById("textFunny").style.color = "red"
  }
}
function calDate() {
